...
export default function PostCard() {
  ...
  return (
    <>
      ...
      <div className="cursor-pointer bg-[var(--card-bg)] rounded-lg shadow-md p-4 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl active:scale-[0.99] border border-transparent hover:border-[var(--primary)] relative">
        ...
        <div onClick={() => setIsOpen(true)}>
          ...
          >
            ...
            <div>
              <p className="font-bold text-[var(--text)] hover:text-[var(--primary)] transition-colors">
                username
              </p>
          ...
          <div className="flex flex-wrap items-center gap-4 mb-2 text-sm text-[var(--text-secondary)]">
            <div className="flex items-center gap-1">
              <MapPin
                size={16}
                className="fill-[var(--primary)] dark:fill-transparent stroke-[var(--primary)]"
              />
          ...
          >
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {["#Volleyball", "#CampusEvent", "#Sports", "#FunWeekend"].map(
                  (tag) => (
                    <span
                      key={tag}
