...
const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    role: 'Backend Co-Lead',
    description: [
      'Co-led backend development and built initial server architecture',
      'Designed Supabase schema with RLS policies',
  ...
  },
  {
    ...
    description: [
      ...
      'Assisted with frontend design, reviewed pull requests',
      'Integrated Frontend and backend endpoints, and implemented web-socket',
    ],
