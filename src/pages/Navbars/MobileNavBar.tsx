    ...
    return (
        ...
        <div className="h-dvh">
            <div className="fixed bottom-0 left-0 flex flex-row w-full bg-[#081E3F] h-3/32 justify-center items-center" style={{ gap: "calc(56/360 * 100%)"}}>
                <Link to="/" className="h-25/60 aspect-square" ><HomeIcon className="w-full h-full"/></Link>
                <Link to="/" className="h-25/60 aspect-square" ><ExploreIcon className="w-full h-full" /></Link>
                <Link to="/" className="h-25/60 aspect-square"><ProfileIcon className="w-full h-full" /></Link>
                <Link to="/" className="h-25/60 aspect-square"><CreateIcon  className="w-full h-full"/></Link>
            </div>
        </div>
        </>
    )
